...
if(($_POST['Input']=="Azbio"||$_POST['Output']=="Azbio")&&($_POST['Input']=="Cnc"||$_POST['Output']=="Cnc"))
{
    ...
    if($_POST['Input']=="Azbio") //convert from Azbio to CNC
    {
        ...
        $answer2['lowanswer']=max(0,$answer2['lowanswer']);
        $answer2['highanswer']=max(0,$answer2['highanswer']);
        $answer2['highanswer']=min(50,$answer2['highanswer']);
        $answer2['lowanswer']=min(50,$answer2['lowanswer']);
        ...
        $answer['lowanswer']=max(0,$answer['lowanswer']);
        $answer['highanswer']=max(0,$answer['highanswer']);
        $answer['highanswer']=min(150,$answer['highanswer']);
        $answer['lowanswer']=min(150,$answer['lowanswer']);
        ...
        $answer['lowanswer']=max(0,$answer['lowanswer']);
        $answer['highanswer']=max(0,$answer['highanswer']);
        $answer['highanswer']=min(100,$answer['highanswer']);
        $answer['lowanswer']=min(100,$answer['lowanswer']);
   ...
   //second score in CNC - Words
        ...
        $answer2['lowanswer']=max(0,$answer2['lowanswer']);
        $answer2['highanswer']=max(0,$answer2['highanswer']);
        $answer2['highanswer']=min(100,$answer2['highanswer']);
        $answer2['lowanswer']=min(100,$answer2['lowanswer']);
...
else if(($_POST['Input']=="Bkb"||$_POST['Output']=="Bkb")&&($_POST['Input']=="Cnc"||$_POST['Output']=="Cnc"))
{
    ...
    if($_POST['Input']=="Bkb") //convert from BKB to CNC
    {
        ...
        $answer = convertor($line, $score1, $linereverse);
        $answer['lowanswer']=max(-23,$answer['lowanswer']);
        $answer['highanswer']=max(-23,$answer['highanswer']);
        $answer['highanswer']=min(23,$answer['highanswer']);
        $answer['lowanswer']=min(23,$answer['lowanswer']);
        print($answer['lowanswer'] . "-" . $answer['highanswer']);
        ...
        $answer2 = convertor($line2, $score2, $line2reverse);
        $answer2['lowanswer']=max(-23,$answer2['lowanswer']);
        $answer2['highanswer']=max(-23,$answer2['highanswer']);
        $answer2['highanswer']=min(23,$answer2['highanswer']);
        $answer2['lowanswer']=min(23,$answer2['lowanswer']);
        print($answer2['lowanswer'] . "-" . $answer2['highanswer']);
